...
import DepressiLess_logo from '../images/DepressiLess-logo.png'
  ...
  <div className="Home">
    ...
    <div data-cy="homeBttnContainer" className="btn-container">
      <div className="btn-row">
        ...
        <Link className="link" to="/new-app">
          <img data-cy="DepressiLessLogo" className="homepage-button" src={DepressiLess_logo} alt="DepressiLess_App_Logo" />
        </Link>
      </div>
    </div>
  </div>
