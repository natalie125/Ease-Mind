...
<br />
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <div style={{ ...containerStyle, marginRight: '5%' }}>
          ...
          <p>
            1. Understanding: Educate yourself about autism to better understand the condition.<br />
            2. Support: Seek support groups and communities for both individuals with autism and their families.<br />
            3. Routine: Maintain a consistent routine, as it can be comforting for individuals with autism.<br />
            4. Communication: Adapt communication methods and be patient in understanding the individual's way of communication.<br />
        ...
        <div style={containerStyle}>
          ...
          <p>
            1. National Autistic Society Helpline: <br />
            0808 800 4104 (Monday to Thursday: 10 am to 4 pm, Friday: 9 am to 3 pm)<br />
            2. Autism Helpline by Ambitious about Autism: <br />
            0800 014 8087 (Monday to Thursday: 10 am to 4 pm, Friday: 9 am to 3 pm)<br />
            3. Autism Wessex: <br />
            01202 483360 (Monday to Friday: 9 am to 5 pm)<br />
            4. Autism Anglia: <br />
